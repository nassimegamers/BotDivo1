...
client.on('ready', () => {
  client.user.setGame(` By .NaSsimééé 😎😋#0001 .`,'');
  console.log('---------------');
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@.NaSsimééé 😎😋#0001  **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.login("NTMzMjA4MTAwMzMzNjgyNjk4.DxnsWg.Ff_ma695imxw12XDOrttm1gadHE");
